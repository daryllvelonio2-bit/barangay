...
public partial class App : Application
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal void _003COnStartup_003Eb__12_1(object _, DispatcherUnhandledExceptionEventArgs args)
		{
			...
			// Show error via the non-blocking dialog service if available
			try
			{
				baranggaysystem1.ViewModels.DialogService.Instance.ShowError(
					"An operation failed: " + (args.Exception?.Message ?? "Unknown error"));
			}
			catch { }
			args.Handled = true;
		}
