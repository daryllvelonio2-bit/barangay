...
public sealed class DialogService
{
	...
	public string? PromptForReason(string title, string prompt, string confirmText = "Confirm")
	{
		ReasonPromptWindow window = new ReasonPromptWindow(title, prompt, confirmText)
		{
			Owner = Application.Current.MainWindow
		};
		return window.ShowDialog() == true ? window.Reason : null;
	}
}
