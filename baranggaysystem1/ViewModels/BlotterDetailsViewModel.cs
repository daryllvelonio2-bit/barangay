...
public partial class BlotterDetailsViewModel : ObservableObject
{
	...
	partial void OnSelectedComplainantResultChanged(BlotterResidentLookupItem? value)
	{
		if (value != null)
		{
	...
	public ObservableCollection<string> IncidentTypes { get; } = new ObservableCollection<string>
	{
		"Physical Assault", "Verbal Abuse", "Theft", "Property Damage", "Trespassing",
		"Domestic Violence", "Noise Complaint", "Harassment", "Fraud", "Threats",
		"Vandalism", "Public Disturbance", "Illegal Gambling", "Drug-Related",
		"Land Dispute", "Boundary Dispute", "Animal Bite", "Traffic Incident", "Other"
	};

	public ObservableCollection<string> StatusOptions { get; } = new ObservableCollection<string>
	{
		"ONGOING", "MEDIATION", "SETTLED", "REFERRED", "CLOSED"
	};
