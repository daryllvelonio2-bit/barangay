-- =========================================================================
-- Barangay Management System - MySQL Seed Data
-- Populates the database with default and demo data
-- =========================================================================
...
-- Barangay
INSERT IGNORE INTO barangay (barangay_id, name) VALUES (1, 'Barangay San Jose');
...
-- Case types
INSERT IGNORE INTO case_type (name) VALUES ('General');

-- Document types
INSERT IGNORE INTO document_type (name, code, requires_approval) VALUES
...
-- Default facilities
INSERT IGNORE INTO barangay_facility (facility_name, facility_type, capacity, hourly_rate, location, is_active) VALUES
('Barangay Hall', 'VENUE', 100, 0.00, 'Main Building', 1),
('Covered Court', 'VENUE', 300, 0.00, 'Plaza Area', 1),
('Multi-Purpose Hall', 'VENUE', 150, 0.00, 'Community Center', 1);

-- Emergency contacts
INSERT IGNORE INTO emergency_contact (category, agency_name, phone_primary, is_priority, is_active) VALUES
('POLICE', 'Philippine National Police (PNP) Emergency', '911', 1, 1),
('FIRE', 'Bureau of Fire Protection (BFP)', '160', 1, 1),
('MEDICAL', 'Red Cross 143 Emergency Hotline', '143', 1, 1),
('DISASTER', 'NDRRMC Emergency Operations Center', '(02) 8911-1406', 1, 1);
...
INSERT IGNORE INTO user_account (user_id, barangay_id, username, password_hash, full_name, first_name, last_name, position, is_active) VALUES
