...
public partial class FullscreenViewHost : UserControl
{
    ...
    internal Action? SavedCallback { get; set; }
    ...
    public void NavigateBack()
    {
        ...
        bool hasDirtyContent = _hasUnsavedChanges ||
            (ContentArea is IUnsavedChangesSource form && form.IsDirty);
        ...
        if (hasDirtyContent)
        {
            ...
            else
            {
                ...
                if (ContentArea is IUnsavedChangesSource dirtySource)
                {
                    dirtySource.IsDirty = false;
                }
            }
        }
