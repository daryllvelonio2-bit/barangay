...
public partial class ResidentClassificationWindow : Window
{
	...
	private readonly ResidentClassificationService _service = new();
	...
	private async void SaveButton_Click(object sender, RoutedEventArgs e)
	{
		...
		try
		{
			...
			Draft.ClassificationId = await _service.SaveClassificationAsync(Draft);
		...
		catch (Exception ex)
		{
			...
			saveButton.Content = _source.ClassificationId > 0 ? "Save Changes" : "Create";
		}
	}
