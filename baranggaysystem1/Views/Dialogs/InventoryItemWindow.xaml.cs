...
{
	private readonly FinanceOperationsService _service = new FinanceOperationsService();
	...
	private async void SaveButton_Click(object sender, RoutedEventArgs e)
	{
		...
		try
		{
			await _service.SaveInventoryItemAsync(Draft);
			EmbeddedDialogSupport.Complete(this);
		}
		catch (Exception ex)
		{
			DialogService.Instance.ShowError(ex.Message, "Inventory Item");
		}
		finally
		{
