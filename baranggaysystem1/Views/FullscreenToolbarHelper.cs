...
public static class FullscreenToolbarHelper
{
    ...
    public static Button CreateToolbarButton(string label, IconChar icon, RoutedEventHandler clickHandler)
    {
        ...
        button.Tag = new FullscreenToolbarActionMetadata(label, clickHandler);
        return button;
    }
}

internal sealed class FullscreenToolbarActionMetadata
{
    public string Label { get; }

    public RoutedEventHandler FallbackHandler { get; }

    public FullscreenToolbarActionMetadata(string label, RoutedEventHandler fallbackHandler)
    {
        Label = label;
